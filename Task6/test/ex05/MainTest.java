...
public class MainTest {
    ...
    /** Перевірка основної функціональності {@linkplain CommandQueue} з {@linkplain MaxCommand} */
    @Test
    ...
    /** Перевірка основної функціональності {@linkplain CommandQueue} з {@linkplain AvgCommand} */
    @Test
    ...
    /** Перевірка основної функціональності {@linkplain CommandQueue} з {@linkplain MinMaxCommand} */
    @Test
