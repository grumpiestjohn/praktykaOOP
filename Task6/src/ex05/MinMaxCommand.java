...
public class MinMaxCommand implements Command /*, Runnable */ {
    ...
    /** Зберігає індекс мінімального елемента */
    private int resultMin = -1;

    /** Зберігає індекс максимального елемента */
    private int resultMax = -1;

    /** Флаг готовності результату */
    ...
    /** Повертає індекс мінімального елемента */
    public int getResultMin() {
        return resultMin;
    }

    /** Повертає індекс максимального елемента */
